...
#define TEST_NAME_CONVERSION(variable)		util::extract_variable_name(#variable)
#define SERIALIZE_KEY_VALUE(variable)		serialize_key_value(util::extract_variable_name(#variable), variable);
